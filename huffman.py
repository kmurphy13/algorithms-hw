# Algorithms HW4 Huffman Encoding
# Author: Kira Murphy
...
if __name__ == "__main__":
    sysargs = sys.argv
    # Load the given file provided by the user by getting the list of character frequencies
    ...
    # Print out the size in bytes with no compression and with our compression algorithm
